...
@section('content')
    ...
    <section class="content-main">
        <div class="alert alert-danger" role="alert">
            Не все тут правильно выводится, надо доделать!
        </div>
            ...
            <div class="col-lg-3">
                <div class="card card-body mb-4">
                    <article class="icontext">
                        ...
                        <div class="text">
                            <h6 class="mb-1 card-title">Orders</h6> <span>{{App\Models\Order::count()}}</span>
                            <span class="text-sm">
            ...
            <div class="col-lg-3">
                <div class="card card-body mb-4">
                    <article class="icontext">
                        ...
                        <div class="text">
                            <h6 class="mb-1 card-title">Products</h6> <span>{{App\Models\Products::count()}}</span>
                            <span class="text-sm">
                                    In {{App\Models\Categories::count()}} Categories
                                </span>
                        </div>
                    </article>
                </div>
